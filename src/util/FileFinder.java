...
public class FileFinder {
	...
	public static void main(String[] args) {
		System.out.println("\nTest 1: ");
		for (File f : FileFinder.GetAllFiles("data/two_newsgroups", ".txt", true)) 
			System.out.println("- " + f);
		
		System.out.println("\nTest 2: ");
		for (File f : FileFinder.GetAllFiles("data/two_newsgroups", null, true)) 
			System.out.println("- " + f);

		System.out.println("\nTest 3: ");
		for (File f : FileFinder.GetAllFiles("data/two_newsgroups", null, false)) 
			System.out.println("- " + f);
	}
